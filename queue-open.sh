...
curl -X PUT -H "Content-Type: application/json" --header "Authorization: Token token=${USER_TOKEN}, email=${USER_EMAIL}" --data @io_non_sono_chiuso.json "$REQ_URL"
